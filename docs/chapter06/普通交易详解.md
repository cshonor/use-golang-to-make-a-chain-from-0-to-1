...
- **[Input和Output关系详解](./Input和Output关系详解.md)** - Input和Output的对应关系、实现机制和关键概念
- **[手续费和找零机制](./手续费和找零机制.md)** - 手续费计算和找零机制详解
- **[交易基础数据结构](./交易基础数据结构.md)** - Tx、TxData结构详解
- **[Annotated结构详解](./Annotated结构详解.md)** - AnnotatedInput和AnnotatedOutput说明
...
> **详细说明**：请参考 [Input和Output关系详解](./Input和Output关系详解.md#如何引用output)
...
> **详细说明**：请参考 [Input和Output关系详解](./Input和Output关系详解.md)
...
### Q5: Input和Output是否都在链上？

**A:** 是的，永远都在链上，永久保存。即使被花费，也只是被标记为"已花费"，数据还在链上。

> **详细说明**：请参考 [Input和Output关系详解](./Input和Output关系详解.md#6-input和output是否都在链上)

---

## 相关资源

- [Input和Output关系详解](./Input和Output关系详解.md) - Input和Output的对应关系、实现机制
- [手续费和找零机制](./手续费和找零机制.md) - 手续费计算和找零机制
